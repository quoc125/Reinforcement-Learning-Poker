...
def test():
   ...
   # setup dqn agent
   agent = dqn.DQNPlayer_Eric('5', player_num, initial_stack, memory_size, update_freq, batch_size, eps_start,
                              eps_end, discount, target_update_freq, 'models/eric/model_4999.pth')
