...
def setup():
   ...
   save_freq = 1000
   save_dir = 'models/model_2_weights'
   ...
   agent = players.DQNPlayer(player_num, memory_size, update_freq, batch_size, eps_start, eps_end, discount, target_update_freq)
